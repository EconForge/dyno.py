...
from dyno.dynsym.grammar import stringify_symbol, stringify_variable, stringify_value, stringify_constant
...
symbols = [v_context[v][+1] for v in model.symbols['endogenous']] \
...
values = [model.data.context['steady_states'][e] for e in model.symbols['endogenous']]*3 \
    + [model.data.context['steady_states'][e] for e in model.symbols['exogenous']]
